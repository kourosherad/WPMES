...
try {
  ...
  try {
    for (const file of ['001_initial_schema.sql', '002_project_route_columns.sql', '003_qc_rework_cases.sql', '004_assembly_project_profiles.sql', '005_production_control_station_ownership.sql']) {
