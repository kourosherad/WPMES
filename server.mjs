...
async function authorizePublicRequest(req, res, pathname, isSecure) {
  ...
  if (['/auth/login.css', '/auth/login-signature-v3.css'].includes(pathname) && req.method === 'GET') {
