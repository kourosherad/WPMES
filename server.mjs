...
function renderLogin(res, invalid = false) {
  ...
  res.end(`<!doctype html><html lang="fa" dir="rtl"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#f4f1ea"><title>ورود به WPMES</title><link rel="stylesheet" href="/auth/login-signature-v2.css"></head><body><main class="login-shell"><section class="login-panel"><div class="brand"><span class="brand-mark"><i></i><i></i><i></i></span><span><b>WPMES</b><small>Wagon Pars Manufacturing Execution System</small></span></div><div class="login-content"><div class="login-copy"><span>سامانه اجرای تولید واگن پارس</span><h1>ورود به فضای<br>عملیات تولید</h1><p>برای ادامه، اطلاعات حساب سازمانی خود را وارد کنید.</p></div>${error}<form method="post" action="/auth/login"><label><span>نام کاربری</span><div class="field"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20 21a8 8 0 0 0-16 0M12 13a5 5 0 1 0 0-10 5 5 0 0 0 0 10Z"/></svg><input name="username" autocomplete="username" placeholder="نام کاربری" required autofocus></div></label><label><span>رمز عبور</span><div class="field"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="10" width="16" height="11" rx="3"/><path d="M8 10V7a4 4 0 0 1 8 0v3M12 15v2"/></svg><input name="password" type="password" autocomplete="current-password" placeholder="رمز عبور" required></div></label><button type="submit"><span>ورود به سامانه</span><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m9 18 6-6-6-6"/></svg></button></form><div class="access-note"><i></i><span>دسترسی محافظت‌شده سازمانی</span></div></div></section><aside class="login-visual" aria-label="نمایش جریان تولید"><header><span>جریان یکپارچه تولید</span><h2>هر مجموعه، یک مسیر روشن</h2><p>رهگیری پیوسته از تعریف مهندسی تا تکمیل عملیات</p></header><div class="factory-scene" aria-hidden="true"><div class="scene-halo"></div><div class="line-label"><span>PRODUCTION FLOW</span><b>LIVE</b></div><div class="production-line"><div class="rail"><i></i><i></i></div><div class="progress-line"></div><div class="workpiece"><span></span><b></b></div><div class="station s1"><span class="station-icon"><svg viewBox="0 0 48 48"><path d="M11 37V19l13-8 13 8v18M17 37V24h14v13M8 37h32"/></svg></span><b>تعریف مسیر</b><small>مهندسی</small></div><div class="station s2"><span class="station-icon"><svg viewBox="0 0 48 48"><path d="M10 35h28M15 35V17h18v18M20 17v-6h8v6M19 25h10"/></svg></span><b>اجرای عملیات</b><small>تولید</small></div><div class="station s3"><span class="station-icon"><svg viewBox="0 0 48 48"><path d="M24 8 37 13v10c0 8-5 14-13 18-8-4-13-10-13-18V13l13-5Z"/><path d="m18 24 4 4 8-9"/></svg></span><b>کنترل کیفیت</b><small>QC</small></div><div class="station s4"><span class="station-icon"><svg viewBox="0 0 48 48"><path d="M9 18 24 9l15 9-15 9-15-9ZM9 18v13l15 9 15-9V18M24 27v13"/></svg></span><b>کنترل تولید</b><small>تأیید</small></div><div class="station s5"><span class="station-icon"><svg viewBox="0 0 48 48"><path d="M9 16h30v22H9zM15 16V9h18v7M17 27l5 5 10-11"/></svg></span><b>تکمیل مسیر</b><small>آماده تحویل</small></div></div><div class="flow-status"><span><i></i>ردیابی لحظه‌ای</span><span>هر اسکن، یک رویداد قابل پیگیری</span></div></div></aside></main></body></html>`);
}
...
async function authorizePublicRequest(req, res, pathname, isSecure) {
  ...
  if (['/auth/login.css', '/auth/login-signature-v2.css'].includes(pathname) && req.method === 'GET') {
